...
func (c *sampleServiceClient) GetHelloWorld(ctx context.Context, in *GetHelloWorldRequest, opts ...grpc.CallOption) (*GetHelloWorldResponse, error) {
	out := new(GetHelloWorldResponse)
	err := c.cc.Invoke(ctx, "/sample.SampleService/GetHelloWorld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSampleServiceServer) GetHelloWorld(context.Context, *GetHelloWorldRequest) (*GetHelloWorldResponse, error) {
...
func _SampleService_GetHelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHelloWorldRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SampleServiceServer).GetHelloWorld(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sample.SampleService/GetHelloWorld",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).GetHelloWorld(ctx, req.(*GetHelloWorldRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SampleService_GetHelloWorld_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "github.com/rifqiakrm/go-microservice/proto/sample/sample.proto",
}
